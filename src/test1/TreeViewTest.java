...
public class TreeViewTest extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        duckRoot.getChildren().addAll(new TreeItem<String>("Huey Duck"), new TreeItem<String>("Dewey Duck"), new TreeItem<String>("Louie Duck"));
        ...
        // is selected
        duckTree.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<TreeItem<String>>() {
        ...
        //Set a ChangeListener to handle events that occur with a Treeitem
        // is selected
        royalTree.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<TreeItem<String>>() {
            public void changed(ObservableValue<? extends TreeItem<String>> observableValue, TreeItem<String> oldItem, TreeItem<String> newItem) {
